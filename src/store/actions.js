...
export const api_v1_hhjhj_list = () => ({ type: types.API_V1_HHJHJ_LIST })
export const api_v1_hhjhj_listSucceeded = (response, starter) => ({
  type: types.API_V1_HHJHJ_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_hhjhj_listFailed = (error, starter) => ({
  type: types.API_V1_HHJHJ_LIST_FAILED,
  error,
  starter
})
export const api_v1_hhjhj_create = data => ({
  type: types.API_V1_HHJHJ_CREATE,
  data
})
export const api_v1_hhjhj_createSucceeded = (response, starter) => ({
  type: types.API_V1_HHJHJ_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_hhjhj_createFailed = (error, starter) => ({
  type: types.API_V1_HHJHJ_CREATE_FAILED,
  error,
  starter
})
export const api_v1_hhjhj_read = () => ({ type: types.API_V1_HHJHJ_READ })
export const api_v1_hhjhj_readSucceeded = (response, starter) => ({
  type: types.API_V1_HHJHJ_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_hhjhj_readFailed = (error, starter) => ({
  type: types.API_V1_HHJHJ_READ_FAILED,
  error,
  starter
})
export const api_v1_hhjhj_update = data => ({
  type: types.API_V1_HHJHJ_UPDATE,
  data
})
export const api_v1_hhjhj_updateSucceeded = (response, starter) => ({
  type: types.API_V1_HHJHJ_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_hhjhj_updateFailed = (error, starter) => ({
  type: types.API_V1_HHJHJ_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_hhjhj_partial_update = data => ({
  type: types.API_V1_HHJHJ_PARTIAL_UPDATE,
  data
})
export const api_v1_hhjhj_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_HHJHJ_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_hhjhj_partial_updateFailed = (error, starter) => ({
  type: types.API_V1_HHJHJ_PARTIAL_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_hhjhj_delete = () => ({ type: types.API_V1_HHJHJ_DELETE })
export const api_v1_hhjhj_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_HHJHJ_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_hhjhj_deleteFailed = (error, starter) => ({
  type: types.API_V1_HHJHJ_DELETE_FAILED,
  error,
  starter
})
